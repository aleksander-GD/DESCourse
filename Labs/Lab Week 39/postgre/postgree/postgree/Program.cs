...
class PostGresHandler
{
	...
	/*
	Is it easy to understand. Does it make sense the way it is.
	Does it handle errors ?
	Waht if there was a change assiociated a change in the code. 
	What if there needs to be redudancy with different databases. 
